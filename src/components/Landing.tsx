    ...
    return (
        <section className='landing'>
            <div className='bg-blue w-full bg-opacity-75 flex flex-col items-center'>
                <div className='flex items-center w-full flex-col gap-3 mt-0 lg:gap-7 justify-center text-center py-10 lg:py-5 lg:my-56 px-4 font-IR'>
                    <div className='max-w-screen-xl my-0 mx-auto'>
                        <h1 className='text-white-100 font-Aviny text-4xl sm:text-6xl lg:text-7xl'>خانه ی رویایی خود را پیدا کنید.</h1>
