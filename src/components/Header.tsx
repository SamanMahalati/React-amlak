...
const Header = () => {
    ...
    return (
        <header className='bg-white-100 w-full'>
            <div className='flex items-center justify-between px-4  py-5 relative max-w-screen-2xl my-0 mx-auto '>
                                ...
                                <Drawer anchor={'right'} open={state['right']} onClose={toggleDrawer('right', false)} >
                                    <Box sx={{ width: 320 }} role="presentation" onClick={toggleDrawer("right", false)} onKeyDown={toggleDrawer("right", false)} >
                                        ...
                                        <ul className='text-zinc-600 font-medium font-IR'>
                                            {
                                                menuItems.map(item =>
                                                    <Link to={item.route} className='flex items-center gap-x-3'>
