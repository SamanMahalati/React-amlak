    ...
    return (
        <div className='flex flex-col items-center justify-center text-center gap-4 py-5 max-w-md my-0 mx-auto px-3'>
            <div className='h-32 w-32 relative'>
                <img className='rounded-full border border-zinc-400 p-1' src={props.person.photo} alt="person" />
            ...
            <div>
                <h1 className='text-lg text-zinc-800'>{props.person.name}</h1>
                <h3 className='text-sm text-zinc-600'>{props.person.job}</h3>
            </div>
            <p className='text-zinc-800'>{props.person.comment}</p>
        </div>
    );
};
